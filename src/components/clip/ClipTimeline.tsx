...
export function ClipTimeline({
  ...
  useEffect(() => {
    ...
    // Add section regions with labels
    sections.forEach((section) => {
      // Create label element for the region
      ...
      labelEl.style.cssText = `
        ...
        white-space: nowrap;
        cursor: pointer;
        ${section.id === selectedSectionId ? 'box-shadow: inset 0 0 0 2px white;' : ''}
      `;
  ...
  }, [sections, isLoading, selectionRange, isAddingSection, selectedSectionId, formatTime]);
