...
export async function GET(request: Request, { params }: RouteParams) {
  try {
    ...
    // Map to full generic character data
...
export async function POST(request: Request, { params }: RouteParams) {
  try {
    ...
    console.log('[GenericAssets API] Inserting via RPC:', { project_id: projectId, generic_asset_id: genericAssetId });
    ...
    return NextResponse.json({
      projectAsset: {
        ...
        name: genericCharacter.name,
        nameFr: genericCharacter.nameFr,
        description: genericCharacter.description,
